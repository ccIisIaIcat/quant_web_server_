...
func main() {
	...
	ob := Order_book{File_name: "btcusdt2022_01_01_19h05m11s", Username: "root", Password: "", Cross_feature_data: "cross_feature_data", Original_data: "original_data", Processed_data: "processed_data", Time_start_id: 30}

	var i info_sender
	new_info := json.Unmarshal(ob.Start(), &i)
	fmt.Println(new_info)
}
